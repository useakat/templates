...
// Thu Aug 18 16:59:31 2011 by ROOT version 5.26/00e
// from TTree LHEF/Analysis tree
// found on file: uux_Wmdxubbx_run01_unweighted_events.root
//////////////////////////////////////////////////////////

#ifndef LHEAnalysis_h
#define LHEAnalysis_h
...
#ifdef LHEAnalysis_cxx
LHEAnalysis::LHEAnalysis(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("uux_Wmdxubbx_run01_unweighted_events.root");
      if (!f) {
         f = new TFile("uux_Wmdxubbx_run01_unweighted_events.root");
      }
...
Int_t LHEAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t LHEAnalysis::LoadTree(Long64_t entry)
{
...
void LHEAnalysis::Init(TTree *tree)
{
...
void LHEAnalysis::Show(Long64_t entry)
{
...
Int_t LHEAnalysis::Cut(Long64_t entry)
{
