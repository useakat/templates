...
C     
      ...
      integer nevent,nx
      real*8 xsec,m1,m2,beta,pi,conv
      parameter (pi=3.141592653589793238d0,CONV=389379.66*1000)
      double precision amin,amax,lamin,lamax,deltala,lx
...
c      call printout()
      ...
      do i = 1,nevent
         ...
         xsec = xsec +matelem
      enddo
      xsec= 1d0/(2*sqrts**2)*xsec
     &     *beta(m1**2/sqrts**2,m2**2/sqrts**2)/(8*pi)
      
      xsec = xsec/dble(nevent)

      write(*,*) xsec*conv," pb" !xsec in pb unit
