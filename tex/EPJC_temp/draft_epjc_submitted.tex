...
\author{Kaoru Hagiwara\inst{1}\fnmsep\thanks{email:kaoru.hagiwara@kek.jp} \and Yoshitaro Takaesu\inst{1}\fnmsep\thanks{email:takaesu@post.kek.jp}
}                     % Do not remove

\institute{KEK Theory Center and Sokendai, Tsukuba, 305-0801, Japan}
%
...
We list the Feynman rules derived from the Lagrangian  (\ref{eq:cflag}) in
...
\begin{align}
 {\cal M}(ng)=&\sum_{\sigma\in S_n/Z_n}\delta^{i_{\sigma(n)}}_{j_{\sigma(n-1)}}
...
basis. We define a $(n+1)$\,-point off-shell gluon current $J^{\mu}(1, 2,\cdots,n;\,x)$ recursively
as
\begin{equation}
...
amplitudes, such as $A(1,\cdots,n)$ in eq.~(\ref{eq:amplitude}), as the
...
\hline\hline
\end{tabular}
\caption{New particles of the CFQCD model when $m =$ the number of gluons
 $+$ the number of quark lines $=6$. The list is shown in the format of {\tt
...
color configuration (\ref{eq:colorconfig}). The partial amplitude for the color flow $(c)$ is calculated with the Feynman rules of
...
\bibitem{MG}T.Stelzer and W.F.Long, Comput. Phys. Commun. \textbf{81}, (1994) 357.
...
\bibitem{GPU2}K.Hagiwara, J.Kanzaki, N.Okamura, D.Rainwater, T.Stelzer, arXiv:0909.5257.
...
\bibitem{HELAC}A.Kanaki, C.G.Papadopoulos, hep-ph/0012004v1.
\bibitem{Alpgen}M.L.Mangano, M.Moretti, F.Piccinini, R.Pittau and A.D.Polosa, JHEP \textbf{0307}, (2003) 001.
\bibitem{giele2010}W.Giele, G.Stavenga, J.-C.Winter, arXiv:1002.3446[hep-ph]
\bibitem{fabio}F.Maltoni, K.Paul, T.Stelzer, S.Willenbrock, Phys.Rev. D \textbf{67}, (2003) 014026.
\bibitem{berends}F.A.Berends, W.T.Giele, Nucl. Phys. \textbf{B306}, (1988) 759. 
\bibitem{multiparton}M.L.Mangano, S.J.Parke, Phys. Rept. \textbf{200}, (1991) 301.
\bibitem{MSSM}G.-C.Cho, K.Hagiwara, J.Kanzaki, T.Plehn,
	D.Rainwater, T.Stelzer, Phys. Rev. D \textbf{73}, (2006) 054002.
\bibitem{CTEQ6L1}CTEQ Collaboration, H.L.Lai et al., Eur. Phys. J. \textbf{C12}, (2000) 375.
\bibitem{BASES}S.Kawabata, Compt. Phys. Commun. \textbf{41}, (1986) 127.
\end{thebibliography}
