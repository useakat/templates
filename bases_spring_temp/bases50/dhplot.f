...
*                                                                      *
 ...
 9010       FORMAT(/1H1)
 9020       FORMAT(A1)
            WRITE(LUN,9100) MAPD(1,ISCAT),(BUFF(I), I=IP3+2,IP3+17)
...
*9310              FORMAT('(5X,F6.3,''   I'',',I2,'(1X,A1),'' I'')')
 9310              FORMAT('(5X,F6.3,''   I'',',I2,'A1,''I'')')
               ENDIF
               WRITE(LUN,FORM) Y,(CHARR(M),M=1,NX)
...
*9500       FORMAT('(6X,''Edge'',5X,',I2,'(1X,A1))')
 9500       FORMAT('(6X,''Edge'',5X,',I2,'A1)')
            WRITE(LUN,FORM1) (CHARR(M),M=1,NX)
